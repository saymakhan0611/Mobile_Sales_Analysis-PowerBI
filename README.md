...
I have develop an interactive Mobile Sales Analysis Dashboard developed using Microsoft Power BI. The dashboard provides a comprehensive view of mobile sales performance across different cities, mobile models, brands, payment methods, customer ratings, months, and days.
## Dateset Used
